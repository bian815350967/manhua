...
<!--    <audio src="http://wting.info/asdb/fiction/xuanhuan/douluodalu0/e6wwi451.mp3"></audio>-->
    <video controls >
      <source src="http://wting.info/asdb/fiction/xuanhuan/douluodalu0/62ercrp9.mp3" type="audio/mpeg" />
    </video>
<!--    底部-->
...
<script type="text/ecmascript-6">
  export default {
    ...
    methods: {
      ...
      getLocalStorage () {
        localStorage.setItem('__douluoVideoPage__', this.pageIndex)
      },
      // 返回上一页
      goback () {
        this.getLocalStorage()
